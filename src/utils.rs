...
pub mod test_utils {
    ...
    pub const DEFAULT_TEST_FEES: Fees = Fees {
        ...
        reflection_fee_numerator: 2,
        reflection_fee_denominator: 100,
        buyback_fee_numerator: 2,
        buyback_fee_denominator: 100,
        marketing_fee_numerator: 2,
        marketing_fee_denominator: 100,
        developer_fee_numerator: 2,
        developer_fee_denominator: 100,
    };
